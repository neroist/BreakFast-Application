...
class BreakFastWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.breakfastTitleLabel.setGeometry(QRect(0, 20, 465, 61))
        ...
        self.breakfastLabel.setGeometry(QRect(0, 80, 465, 50))
...
if __name__ == '__main__':
    ...
    ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("alice.BreakfastApp") # So the window icon shows up on the taskbar
